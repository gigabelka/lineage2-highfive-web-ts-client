...
abstract class UBaseMaterial extends UObject {
  ...
  public abstract getDecodeInfo(
    builder: GD.DecodeLibraryBuilder,
  ): GD.IBaseMaterialDecodeInfo | string;
...
abstract class UCombiner extends UBaseModifier {
  ...
  public getDecodeInfo(
    ...
    switch (this.combineOperation.valueOf()) {
      case EColorOperation_T.CO_Use_Color_From_Material1:
        combineMode = 0;
        break;
      case EColorOperation_T.CO_Multiply:
        combineMode = this.modulate4X ? 3 : this.modulate2X ? 2 : 1;
        break;
      case EColorOperation_T.CO_Add:
        combineMode = 4;
        break;
      case EColorOperation_T.CO_Subtract:
        combineMode = 5;
        break;
      case EColorOperation_T.CO_AlphaBlend_With_Mask:
        combineMode = 6;
        break;
      case EColorOperation_T.CO_Use_Color_From_Material2:
        combineMode = 7;
        break;
      default:
        combineMode = 0;
        break; // CO_Add_With_Mask_Modulation, CO_Use_Color_From_Mask: not yet implemented in the shader
    }
    ...
    return {
      ...
      alphaFrom1:
        this.alphaOperation.valueOf() ===
        EAlphaOperation_T.AO_Use_Alpha_From_Material1,
      alphaFrom2:
        this.alphaOperation.valueOf() ===
        EAlphaOperation_T.AO_Use_Alpha_From_Material2,
...
abstract class UFinalBlend extends UBaseModifier {
  ...
  public getDecodeInfo(
    ...
    switch (this.frameBufferBlending.valueOf()) {
      case EFrameBufferBlending.FB_Overwrite:
        blendingMode = "normal";
        break;
      case EFrameBufferBlending.FB_Modulate:
        blendingMode = "modulate";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_AlphaBlend:
        blendingMode = "normal";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_AlphaModulate_MightNotFogCorrectly:
        blendingMode = "alphaModulate";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_Translucent:
        blendingMode = "translucent";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_Darken:
        blendingMode = "darken";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_Brighten:
        blendingMode = "brighten";
        transparent = true;
        break;
      case EFrameBufferBlending.FB_Invisible:
        blendingMode = "invisible";
        transparent = true;
        break;
      default:
        console.warn(
          "Unknown FinalBlend blending mode:",
          this.frameBufferBlending,
        );
        break;
    }
...
abstract class UShader extends UMaterial {
  ...
  public getDecodeInfo(
    ...
    const selfIllumination = specular
      ? null
      : builder.pullMaterial(this.selfIllumination);
    const selfIlluminationMask = specular
      ? null
      : builder.pullMaterial(this.selfIlluminationMask);
    ...
    switch (this.outputBlending.valueOf()) {
      ...
      case OutputBlending_T.OB_Masked:
        blendingMode = "masked";
        break;
      case OutputBlending_T.OB_Modulate:
        blendingMode = "modulate";
        break;
      case OutputBlending_T.OB_Translucent:
        blendingMode = "translucent";
        break;
      case OutputBlending_T.OB_Invisible:
        blendingMode = "invisible";
        break;
      case OutputBlending_T.OB_Brighten:
        blendingMode = "brighten";
        break;
      case OutputBlending_T.OB_Darken:
        blendingMode = "darken";
        break;
      default:
        console.warn("Unknown blending mode:", this.outputBlending);
        break;
    }
  ...
  public getTextureSize(): { width: number; height: number } | null {
    return (
      this.diffuse?.loadSelf?.().getTextureSize() ||
      this.opacity?.loadSelf?.().getTextureSize() ||
      null
    );
  }
}
...
abstract class UFadeColor extends UBaseModifier {
  ...
  public getDecodeInfo(
    ...
    const fadeType =
      this.fadeType === EColorFadeType_T.FC_Sinusoidal
        ? "sinusoidal"
        : "linear";
...
abstract class UTexRotator extends UBaseModifier {
  ...
  public getDecodeInfo(
    ...
    switch (this.type.valueOf()) {
      case TexRotationType_T.TR_FixedRotation:
        rotationType = "fixed";
        break;
      case TexRotationType_T.TR_ConstantlyRotating:
        rotationType = "rotating";
        break;
      case TexRotationType_T.TR_OscillatingRotation:
        rotationType = "oscillating";
        break;
    }
    ...
    return {
      ...
      transform: {
        ...
        oscillationRate: [
          this.oscillationRate.pitch,
          this.oscillationRate.yaw,
          this.oscillationRate.roll,
        ],
        oscillationAmplitude: [
          this.oscillationAmplitude.pitch,
          this.oscillationAmplitude.yaw,
          this.oscillationAmplitude.roll,
        ],
        oscillationPhase: [
          this.oscillationPhase.pitch,
          this.oscillationPhase.yaw,
          this.oscillationPhase.roll,
        ],
      },
...
abstract class UTexOscillator extends UBaseModifier {
  ...
  public getDecodeInfo(
    ...
    const mapType = (
      type: ETexOscillationType_T,
    ): "pan" | "stretch" | "stretchRepeat" | "jitter" => {
      switch (type.valueOf()) {
        case ETexOscillationType_T.OT_Pan:
          return "pan";
        case ETexOscillationType_T.OT_Stretch:
          return "stretch";
        case ETexOscillationType_T.OT_StretchRepeat:
          return "stretchRepeat";
        case ETexOscillationType_T.OT_Jitter:
          return "jitter";
        default:
          return "pan";
      }
