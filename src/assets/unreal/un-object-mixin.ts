...
if (!UNativeRegistry.hasNativeFunc(197))
    UNativeRegistry.registerNativeFunc(197, function op_native_197() { throw new Error("native 197 is disasm-only"); });
...
Object.assign(UObject.prototype, {
    ...
    loadProperty(this: any, pkg: any, tag: any) {
        ...
        if (!varName) { pkg.seek(offEnd, "set"); return; }
        ...
        if (!property || property.type !== tag.type) { pkg.seek(offEnd, "set"); return; }
