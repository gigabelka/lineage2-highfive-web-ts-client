...
class FBSPNode implements C.IConstructable {
  ...
  public getChildren() {
    return [this.iBack, this.iFront, this.iPlane];
  }
  ...
  public getBSPDecodeInfo(
    surfFlags: number,
  ): Omit<GD.IBSPNodeDecodeInfo_T, "sectionIndex" | "collision" | "zoneMask"> {
    return {
      ...
      spheres: {
        exclusive: [
          this.exclusiveSphereBound.x,
          this.exclusiveSphereBound.y,
          this.exclusiveSphereBound.z,
          this.exclusiveSphereBound.w,
        ],
        inclusive: [
          this.inclusiveSphereBound.x,
          this.inclusiveSphereBound.y,
          this.inclusiveSphereBound.z,
          this.inclusiveSphereBound.w,
        ],
      },
    };
  }
