...
/* item body_part values the character assembly can equip, per equipment slot */
const CHARACTER_ARMOR_SLOTS = { chest: 10, legs: 11, gloves: 9, boots: 12 };

const SCHEMA_ARMORGRP_DAT = [
...
export { SCHEMA_ARMORGRP_DAT, CHARACTER_ARMOR_GROUPS, CHARACTER_ARMOR_SLOTS };
