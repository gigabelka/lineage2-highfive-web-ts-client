...
class UGlowPass extends Pass {
  ...
  render(renderer: any, writeBuffer: any, readBuffer: any) {
    const oldLogarithmicDepthBuffer =
    ...
    // 2. Blur Horizontal
    this.materialBlurH.uniforms.tDiffuse.value =
    ...
    this.materialCombine.uniforms.bloomScale.value =
      this.materialBright.uniforms.bloomScale.value; // Sync param
